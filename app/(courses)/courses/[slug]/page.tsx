...
import { Clock, Users, CheckCircle, BookOpen, ArrowLeft, ExternalLink, FolderGit2 } from 'lucide-react'
        ...
        <div className="container">
          <div className="course-detail-grid">
            ...
            <div>
              ...
              <div style={{ marginBottom: '3rem' }}>
                <h2 className="heading-sm" style={{ marginBottom: '1.25rem' }}>
                  Hands-On Projects Included ({course.projects.length})
                </h2>
                <div style={{ display: 'grid', gap: '1rem' }} aria-label="Course projects">
                  {course.projects.map((proj) => (
                    <div key={proj.title} style={{ padding: '1.25rem', borderRadius: 'var(--r)', background: 'rgba(16, 185, 129, 0.04)', border: '1px solid rgba(16, 185, 129, 0.15)' }}>
                      <h3 style={{ fontSize: '0.95rem', fontWeight: 700, color: 'var(--emerald-light)', display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem' }}>
                        <FolderGit2 size={16} aria-hidden="true" /> {proj.title}
                      </h3>
                      <p className="body" style={{ fontSize: '0.85rem', color: 'var(--text-2)', lineHeight: 1.5 }}>
                        {proj.description}
                      </p>
                    </div>
                  ))}
              ...
              <div className="course-price-box">
                ...
                <ul style={{ display: 'flex', flexDirection: 'column', gap: '0.625rem' }}>
                  {[
                    ...
                    `${course.projects.length} hands-on projects`,
